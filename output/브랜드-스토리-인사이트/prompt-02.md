...
Visual direction:
- Create a supporting visual related to "먼저 핵심만 잡기" and "브랜드 스토리 인사이트", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the badge "INSIGHT 01" in the top-left corner.
