...
Topic: 브랜드 스토리 인사이트
Target audience: 인스타그램 사용자
Card: 4 of 6
Card role: body
Design concept: 에디토리얼 인사이트형 (editorial)
Visual style: 잡지형 (magazine)

Visual direction:
- Create a supporting visual related to "실행 순서를 작게 나누기" and "브랜드 스토리 인사이트", using simple objects, subtle depth, and clear information-design composition.
- Layout archetype: magazine spread. Use asymmetric composition, refined cropping, pull-quote energy, and controlled texture.
- Hard visual style rule: magazine editorial layout. Use premium art direction, sophisticated crop tension, column rhythm, cover-story energy, and avoid checklist UI or meme-card styling.
...
- Series ID: 브랜드 스토리 인사이트 | editorial | magazine
- Repeated visual motif: 브랜드 스토리 인사이트를 상징하는 반복 오브젝트를 모든 카드에서 같은 질감과 시점으로 유지합니다.
- Layout system: 에디토리얼 인사이트형 카드뉴스로 보이도록 여백, 제목 위치, 보조 시각 요소의 크기를 일관되게 유지합니다.
...
- Show only the badge "INSIGHT 03" in the top-left corner.
...
Eyebrow: INSIGHT 03
Title: 실행 순서를 작게 나누기
Body: 브랜드 스토리 인사이트을 볼 때 놓치기 쉬운 관점을 짚어봅니다.
Footer: 브랜드 스토리 인사이트
