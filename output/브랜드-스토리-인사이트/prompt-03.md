...
Visual direction:
- Create a supporting visual related to "내 상황과 맞는지 확인" and "브랜드 스토리 인사이트", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the badge "INSIGHT 02" in the top-left corner.
