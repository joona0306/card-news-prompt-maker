...
Visual direction:
- Create a calm closing visual for saving, checking, or reviewing next steps related to "전세 계약 전 확인할 5가지".
...
Title: 마지막으로 기억할 것
Body: 전세 계약 전 확인할 5가지는 상황에 따라 달라질 수 있습니다. 저장 후 내 조건과 최신 기준을 다시 확인하세요.
