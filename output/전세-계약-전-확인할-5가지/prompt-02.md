...
Visual direction:
- Create a supporting visual related to "먼저 핵심만 잡기" and "전세 계약 전 확인할 5가지", using simple objects, subtle depth, and clear information-design composition.
