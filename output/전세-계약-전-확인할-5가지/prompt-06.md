...
Target audience: 전세 계약을 앞둔 임차인
Card: 6 of 8
Card role: body
Design concept: 체크리스트 강조형 (bold)
Visual style: 3D형 (3d)

Visual direction:
- Create a supporting visual related to "특약과 계약 조건 분리" and "전세 계약 전 확인할 5가지", using simple objects, subtle depth, and clear information-design composition.
...
- Hard visual style rule: isometric 3D render. Use modeled objects, soft studio lighting, ambient occlusion, tactile clay or plastic materials, and avoid photography, flat vector illustration, or meme typography.
...
- Series ID: 전세 계약 전 확인할 5가지 | bold | 3d
...
- Show only the badge "CHECK 05" in the top-left corner.
...
Eyebrow: CHECK 05
Title: 특약과 계약 조건 분리
Body: 전세 계약 전 확인할 5가지에서 바로 확인할 핵심 기준입니다.
Bullets:
- 수리 범위
- 잔금 전 말소 조건
Footer: 전세 계약 전 확인할 5가지
...
- Sources:
- 국가법령정보센터 공인중개사법 (https://www.law.go.kr/), checked at 2026-05-21
- Forbidden claims:
- 확정 수익
- 무조건 안전
- 최저가 보장
