...
Visual direction:
- Create a supporting visual related to "입주 후 절차 확인" and "전세 계약 전 확인할 5가지", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the badge "CHECK 06" in the top-left corner.
