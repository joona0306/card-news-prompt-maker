...
Visual direction:
- Create a supporting visual related to "보증금 반환 위험 보기" and "전세 계약 전 확인할 5가지", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the badge "CHECK 02" in the top-left corner.
