...
Visual direction:
- Create one memorable visual metaphor for "전세 계약 전 확인할 5가지" using a clean editorial illustration or realistic lifestyle object scene, with empty space for the headline.
