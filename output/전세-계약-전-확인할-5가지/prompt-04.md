...
Visual direction:
- Create a supporting visual related to "전입신고와 확정일자" and "전세 계약 전 확인할 5가지", using simple objects, subtle depth, and clear information-design composition.
...
Eyebrow: CHECK 03
Title: 전입신고와 확정일자
Body: 전입신고와 확정일자는 별도 확인 항목으로 다룹니다.
Bullets:
- 국가법령정보센터와 보증기관 안내를 함께 확인합니다.
