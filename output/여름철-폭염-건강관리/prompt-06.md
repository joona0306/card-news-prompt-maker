...
Topic: 여름철 폭염 건강관리
Target audience: 폭염 시 야외 활동이 있거나 더위에 취약한 일반 성인과 보호자
Card: 6 of 8
Card role: body
Design concept: 정보 정리형 (educational)
Visual style: 밈형 (meme)

Visual direction:
- Create a supporting visual related to "위험 증상은 빨리 알아차리기" and "여름철 폭염 건강관리", using simple objects, subtle depth, and clear information-design composition.
- Layout archetype: explainer diagram. Use a structured grid, one small visual system, labels as shapes only, and a calm learning rhythm.
...
- Show only the page number "6/8" in a quiet corner.
...
- Checked facts:
  - 온열질환 예방의 기본은 물 자주 마시기, 시원하게 지내기, 더운 시간대 활동 자제입니다.
  - 폭염 시 어린이, 노인, 만성질환자 등 취약군은 가족과 보호자의 확인이 필요합니다.
  - 의식 저하나 혼란 같은 심한 증상은 응급 상황으로 보고 즉시 도움을 요청해야 합니다.
- Must include:
  - 본 콘텐츠는 일반 건강 정보이며, 증상이 심하거나 지속되면 의료 전문가 상담과 응급 도움을 우선합니다.
  - 카드마다 진단이나 치료 확정을 암시하지 않습니다.
- Source notes:
  - 질병관리청 폭염 건강수칙과 온열질환 예방 자료를 기준으로 검수합니다.
  - 게시 전 최신 폭염특보와 지역 보건 안내를 확인합니다.

Text must be exactly:
Title: 위험 증상은 빨리 알아차리기
Body: 어지러움, 두통, 메스꺼움, 근육경련, 심한 피로가 있으면 즉시 시원한 곳에서 쉬고 도움을 요청합니다.
Bullets:
- 어지러움·두통
- 메스꺼움·근육경련
Footer: 여름철 폭염 건강관리
...
- Review required: yes
- Reviewer role: 의사 또는 의료 전문가
- Review status: required
- Disclaimer: 본 콘텐츠는 일반 건강 정보이며, 진단과 치료는 의료 전문가 상담이 필요합니다. 의식 저하, 혼란, 발작 등 응급 증상은 즉시 119에 연락하세요.
- Sources:
- 질병관리청 폭염 건강수칙홍보자료 (https://www.kdca.go.kr/menu.es?mid=a20205050200), checked at 2026-05-21
- 대한민국 정책브리핑 질병관리청 보도자료 - 물·그늘·휴식으로 온열질환 예방해요 (https://m.korea.kr/briefing/pressReleaseView.do?newsId=156687433), checked at 2026-05-21
- Forbidden claims:
- 완치 보장
- 부작용 없음
- 100% 효과
