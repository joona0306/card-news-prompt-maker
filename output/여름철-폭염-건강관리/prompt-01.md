...
Visual direction:
- Create one memorable visual metaphor for "여름철 폭염 건강관리" using a clean editorial illustration or realistic lifestyle object scene, with empty space for the headline.
...
Title: 여름철 폭염 건강관리
Body: 폭염 시 야외 활동이 있거나 더위에 취약한 일반 성인과 보호자를 위한 핵심 정리
