...
Visual direction:
- Create a supporting visual related to "고위험군은 더 자주 확인" and "여름철 폭염 건강관리", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the page number "5/8" in a quiet corner.
...
Title: 고위험군은 더 자주 확인
Body: 어린이, 노인, 임신부, 만성질환자, 야외근로자는 더위 증상과 실내 온도를 자주 확인합니다.
Bullets:
- 어린이·노인
- 만성질환자·야외근로자
Footer: 여름철 폭염 건강관리
