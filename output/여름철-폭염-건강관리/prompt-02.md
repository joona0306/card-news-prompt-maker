...
Visual direction:
- Create a supporting visual related to "먼저 핵심만 잡기" and "여름철 폭염 건강관리", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the page number "2/8" in a quiet corner.
- Do not show badges, eyebrows, POINT labels, or corner category tags.


Text must be exactly:
Title: 먼저 핵심만 잡기
Body: 여름철 폭염 건강관리에서 가장 중요한 것은 전체 정보를 한 번에 외우는 것이 아니라, 판단 기준을 먼저 세우는 것입니다.
Bullets:
- 대상: 인스타그램 사용자
- 목표: 핵심 정보를 빠르게 이해시키기
Footer: 여름철 폭염 건강관리
