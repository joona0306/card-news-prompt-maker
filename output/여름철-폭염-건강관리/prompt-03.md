...
Visual direction:
- Create a supporting visual related to "더운 시간대 활동 줄이기" and "여름철 폭염 건강관리", using simple objects, subtle depth, and clear information-design composition.
...
Title: 더운 시간대 활동 줄이기
Body: 폭염특보나 한낮 더위에는 야외 활동과 강한 운동을 줄이고 시원한 곳에 머뭅니다.
Bullets:
- 한낮 외출 줄이기
- 그늘·냉방 장소 이용
Footer: 여름철 폭염 건강관리
