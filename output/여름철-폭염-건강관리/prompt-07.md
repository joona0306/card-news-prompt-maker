...
Visual direction:
- Create a supporting visual related to "의식 이상은 응급 상황" and "여름철 폭염 건강관리", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the page number "7/8" in a quiet corner.
...
Title: 의식 이상은 응급 상황
Body: 의식 저하, 혼란, 발작, 고열이 보이면 119에 연락하고 몸을 식히며 곁에 머뭅니다.
Bullets:
- 119 신고
- 시원하게 식히기
Footer: 여름철 폭염 건강관리
