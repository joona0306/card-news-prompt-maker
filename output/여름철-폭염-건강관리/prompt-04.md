...
Visual direction:
- Create a supporting visual related to "옷차림과 햇볕 차단" and "여름철 폭염 건강관리", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the page number "4/8" in a quiet corner.
...
Title: 옷차림과 햇볕 차단
Body: 외출이 필요하면 밝고 헐렁한 옷, 챙 넓은 모자, 양산으로 열 노출을 줄입니다.
Bullets:
- 밝고 헐렁한 옷
- 모자·양산 사용
Footer: 여름철 폭염 건강관리
