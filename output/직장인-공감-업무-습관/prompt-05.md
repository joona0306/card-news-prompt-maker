...
Visual direction:
- Create a supporting visual related to "퇴근 전 10분 정리" and "직장인 공감 업무 습관", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the badge "NOTE 04" in the top-left corner.
