...
Topic: 직장인 공감 업무 습관
Target audience: 매일 업무와 회의, 메신저 알림에 치이는 직장인
Card: 2 of 6
Card role: body
...
Visual direction:
- Create a supporting visual related to "출근하자마자 3개만 고르기" and "직장인 공감 업무 습관", using simple objects, subtle depth, and clear information-design composition.
...
- Show only the badge "NOTE 01" in the top-left corner.
